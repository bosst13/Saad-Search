    ...
    <div class="col-span-3">
        <div class="grid grid-cols-1 gap-6 pt-4 pb-16 items-start">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <a href="{{ route('showproperty', ['id' => $property->id]) }}" class="block w-full py-1 text-center text-white bg-primary border border-primary rounded-b hover:bg-transparent hover:text-primary transition">View</a>
            </div>
...
{{-- Property listings --}}
<div class="container grid grid-cols-1 gap-6 pt-4 pb-16 items-start">
    {{-- Iterate over each property --}}
